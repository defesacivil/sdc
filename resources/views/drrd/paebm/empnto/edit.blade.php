    ...
    <div class="row flex-fill">
        ...
        <div class="col-md-12">
            ...
            <div class='col-md-12'>
                ...
                {{ Form::token() }}
                <!-- fecha a janela de edição do empreendimento -->
                <input type="hidden" name="close" id="close" value="{{ Request::get('close') }}">
                ...
                <div class='p-2 row'>
                    ...
                    <div class="col">
                        ...
                        {{ Form::text('mina', $empnto->mina, ['class' => 'form form-control', 'id' => 'mina']) }}
                    </div>
                </div>
                <div class="p-2 row">
                    <div class='col'>
                ...
                <div class="p-2 row">
                    ...
                    <div class="col-6">
                        ...
                        {{ Form::text('coordenador_sub', $empnto->coordenador_sub, ['class' => 'form form-control', 'id' => 'coordenador_sub']) }}
                    </div>
                </div>
                ...
                <div class="p-2 row">
                    ...
                    <div class="col-6">
                        ...
                        {{ Form::text('tel_coordenador_sub', $empnto->tel_coordenador_sub, ['class' => 'typeahead form form-control', 'id' => 'tel_coordenador_sub']) }}
                    </div>
                </div>
                <div class="p-2 row">
                    <div class="col-6">
                        {{ Form::label('email_coord', 'Email do Coordenador') }}:
                        {{ Form::email('email_coord', $empnto->email_coord, ['class' => 'form form-control', 'id' => 'email_coord']) }}
                    </div>
                    <div class="col-6">
                        {{ Form::label('email_coord_sub', 'Email do Coordenador Substituto', ['class' => 'font-italic text-secondary']) }}:
                        {{ Form::email('email_coord_sub', $empnto->email_coord_sub, ['class' => 'form form-control', 'id' => 'email_coord_sub']) }}
                    </div>
                </div>
