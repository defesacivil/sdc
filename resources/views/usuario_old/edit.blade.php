...
@section('content')
    ...
    <legend>Editar Usuario CEDEC</legend>
    ...
    <div class='col-md-12'>
        ...
        <div class='row'>
            <div class='col'>
                {{ Form::hidden('id', $cedecusuario->id)}}
            ...
            <div class='col'>
                ...
                {{ Form::text('nome', $cedecusuario->nome, ['class' => 'form form-control', 'value' => old('nome')]) }}
                <br>
            </div>
        </div>
        ...
        <div class='row'>
            ...
            <div class='col'>
                ...
                {{ Form::text('cpf', old('cpf', $cedecusuario->cpf), [
        ...
        <div class='row'>
            <div class='col'>
                ...
                {{ Form::text('login', $cedecusuario->login, ['class' => 'form form-control' ]) }}
                <br>
            </div>
            <div class='col'>
        ...
        <div class='row'>
            <div class='col'>
                ...
                <div class='form-check'>
                    {{Form::checkbox('situacao', 
                                        $cedecusuario->situacao,
                                        ( ($cedecusuario->situacao == 0) ? false : true),
                                         )}}
            ...
            <div class='col'>
                ...
                <div class='form-check'>
                    {{Form::checkbox('it_m_deposito', 
                                        $cedecusuario->it_m_deposito,
                                        ( ($cedecusuario->it_m_deposito == 0) ? false : true),
                                         )}}
            ...
            <div class='col'>
                ...
                <div class='form-check'>
                    {{Form::checkbox('it_m_pipa', 
                                        $cedecusuario->it_m_pipa,
                                        ( ($cedecusuario->it_m_pipa == 0) ? false : true),
                                         )}}
        ...
        <div class="row">
            <div class='col'>
                ...
                <div class='form-check'>
                    {{Form::checkbox('it_m_cce', 
                                        $cedecusuario->it_m_cce,
                                        ( ($cedecusuario->it_m_cce == 0) ? false : true),
                                         )}}
            ...
            <div class='col'>
                    ...
                    <div class='form-check'>
                        {{Form::checkbox('it_m_decretacao', 
                                        $cedecusuario->it_m_decretacao,
                                        ( ($cedecusuario->it_m_decretacao == 0) ? false : true),
                                         )}}
            ...
            <div class='col'>
                ...
                <div class='form-check'>
                    {{Form::checkbox('it_m_comdec', 
                                        $cedecusuario->it_m_comdec,
                                        ( ($cedecusuario->it_m_comdec == 0) ? false : true),
                                         )}}
        ...
        <div class='row'>
            <div class='col'>
                ...
                <div class='form-check'>
                    {{Form::checkbox('it_m_apoio', 
                                        $cedecusuario->it_m_apoio,
                                        ( ($cedecusuario->it_m_apoio == 0) ? false : true),
                                         )}}
            ...
            <div class='col'>
                ...
                <div class='form-check'>
                    {{Form::checkbox('it_m_poco', 
                                        $cedecusuario->it_m_poco,
                                        ( ($cedecusuario->it_m_poco == 0) ? false : true),
                                         )}}
            ...
            <div class='col'>
                ...
                <div class='form-check'>
                    {{Form::checkbox('it_m_escola', 
                                        $cedecusuario->it_m_escola,
                                        ( ($cedecusuario->it_m_escola == 0) ? false : true),
                                         )}}
        ...
        <div class='row'>
            ...
            <div class='col'>
                ...
                <div class='form-check'>
                    {{Form::checkbox('cedec_admin', 
                                        $cedecusuario->cedec_admin,
                                        ( ($cedecusuario->cedec_admin == 0) ? false : true),
                                         )}}
