...
@section('content')
    <div class="row flex-fill">
        ...
        <div class="col-md-12">
                <p class="pt-4"><a class='btn btn-success btn-sm' href={{ url('estoque') }}>Voltar</a></p>
            ...
            @can('cedec')
                ...
                <div class="row">
                    <div class="col text-center">
                        <a href="{{ url('estoque/fornecedor') }}"><img width="150"
                                src="{{ url('imagem/icon/cadastro.png') }}"></a>
                        <h5>Fornecedores</h5>
                    </div>
                    <div class="col text-center">
                        <a href="{{ url('estoque/movimentacao') }}"><img width="130"
                                src="{{ url('imagem/icon/movimentacao.png') }}"></a>
