                    ...
                    <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="row p-4">
                                ...
                                <div class="col text-center">
                                    <div class="small-box bg-info h-100">
                                        <div class="inner">
                                            <p>Cobra Iss</p>
                                            <h3>{{ $municipio->cobra_iss }}</h3>
                                            <p>{{ $municipio->aliquota_iss }}%</p>
                                        </div>
                                        <div class="icon">
                                ...
                                {{-- qtd ponto de captacao --}}
                                <div class="col text-center">
                                    <div class="small-box bg-info h-100">
                                        <div class="inner">
                                            <p>Pontos de Captação</p>
                                            <h3>{{ count($pontos) }}</h3>
                                            <p>-</p>
                                        </div>
                                        <div class="icon">
                                ...
                                {{-- qtd comunidades pmda --}}
                                <div class="col text-center">
                                    <div class="small-box bg-info h-100">
                                        <div class="inner">
                                            <p>Comunidades do PMDA</p>
                                            <h3>{{ count($comunidades) }}</h3>
                                            <p>-</p>
                                        </div>
                                        <div class="icon">
                                            <i class="ion ion-bag"></i>
                                ...
                                {{-- qtd representantes das comunidades --}}
                                <div class="col text-center">
                                    @php
                                        if (count($comunidades) * 3 < count($representantes) ? '' : '') {
                                            $bg = 'bg-info';
                                        } else {
                                            $bg = 'bg-danger';
                                            $title = 'Existe comunidades que não tem 3 representantes conforme regras para análise de PMDA, gentileza verificar';
                                        }
                                    @endphp
                                    <div class="small-box {{ $bg }} h-100" title='{{ $title }}'>
                                        <div class="inner">
                                            <p>Representantes das Comunidades</p>
                        ...
                        <div class="tab-pane fade show" id="iss" role="tabpanel" aria-labelledby="iss-tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col form-group">
                                    {{ Form::label('Alíquota %') }}
                                    {{ Form::text('aliquota_iss', $municipio->aliquota_iss, ['class' => 'form-control', 'id' => 'aliquota_iss', 'maxlength' => '4']) }}
                                </div>
                            </div>
                            <div class="row">
                                <div class="col form-group">
                                    {{ Form::label('Responsabilidade Cobrança') }}
                                    {{ Form::select('resp_cob_iss', ['-', 'Prestador' => 'Prestador', 'Tomador' => 'Tomador'], $municipio->resp_cob_iss, ['class' => 'form-control', 'id' => 'resp_cob_iss']) }}

                                </div>
                                <div class="col form-group">
                                    {{ Form::label('Número da Lei / Ano') }}
                                    {{ Form::text('num_lei_iss', $municipio->num_lei_iss, ['class' => 'form-control', 'maxlength' => '20', 'id' => 'num_lei_iss']) }}
                                </div>
                            </div>
