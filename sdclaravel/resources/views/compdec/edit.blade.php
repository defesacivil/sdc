    ...
    <div class="row flex-fill">
        ...
        <div class="col-md-12">
            ...
            <div class='row'>
                <div class='col-md-6'>
                    <!-- FOTO DO PREFEITO -->
                    <div class='col-md-5 text-center' id='alt_foto_prefeito'>
                    ...
                    <div class='col-md-6' id='form_upload_foto_prefeito'>
                ...
                <div class='col-md-6 text-center'>
                    <!-- FOTO DO COORDENADOR -->
                    <div class="col-md-6 text-center" id='alt_foto_compdec'>
                        <div class="card border-dark mb-3" style="max-width: 18rem; max-height: 18rem; min-height: 16rem;">
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="municipio-tab" role="tabpanel" aria-labelledby="municipio-tab">
                        ...
                        {{ Form::token() }}<div class='col'>
                            ...
                            <legend class="alert alert-info">Endereço e Contatos</legend>
                    ...
                    <div class="tab-pane fade" id="gerais-tab" role="tabpanel" aria-labelledby="gerais-tab">
                        ...
                        <br>
                        <legend class="alert alert-info">Dados Complementares</legend>
