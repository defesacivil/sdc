    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                ...
                {{ Form::token() }}
                {{ Form::hidden('municipio_id', $vistoria->municipio_id, ['required maxlenght=6']) }}
                {{ Form::hidden('numero', $vistoria->numero, ['required maxlenght=15']) }}
                {{ Form::hidden('id', $vistoria->id, ['required maxlenght=15']) }}
                    ...
                    <div class="col">
                        <fieldset class="border p-2">
                            ...
                            <div class="col p-2">
                                ...
                                {{ Form::select('tp_ocorrencia', [
                                    'Normal' => 'Normal',
                                     'Emergencial' => 'Emergencial'],
                                      $vistoria->tp_ocorrencia,
                                       ['class' => 'form form-control', 'id' => 'tp_ocorrencia', 'maxlength' => '50', 'required']) }}
                            </div>
                            <div class="col p-2">
                                {{ Form::label('tp_imovel', 'Tipo de Imóvel') }} :
                                {{ Form::select('tp_imovel', [
                                    'Casa' => 'Casa',
                                     'Apartamento' => 'Apartamento',
                                      'Predio' => 'Predio',
                                       'Galpão' => 'Galpão',
                                        'Lote' => 'Lote', 
                                        'Praça' => 'Praça'], $vistoria->tp_imovel, ['class' => 'form form-control', 'id' => 'tp_imovel', 'required', 'placeholder' => '']) }}
                            </div>
                        </fieldset>
                    </div>
                </div>
                    ...
                    <div class="col">
                        <fieldset class="border p-2">
                            ...
                            <div class="col-md-12 p-2">
                                ...
                                {{ Form::text('prop', $vistoria->prop, ['class' => 'form form-control', 'required maxlenght=70']) }}
                            </div>
                            <div class="row p-2">
                                <div class="col p-2">
                                    {{ Form::label('cel', 'Contato/Telefone') }}:
                                    {{ Form::text('cel', $vistoria->cel, ['class' => 'form form-control', 'id' => 'tel', 'required', 'maxlength' => '15', 'placehold' => 'Telefone de Contato']) }}
                                </div>
                            ...
                            <div class="col-md-12 p-2">
                                ...
                                {{ Form::select('criancas', ['1' => 'Sim', '0' => 'Não'], $vistoria->criancas, ['class' => 'form form-control', 'id' => 'idosos', 'placeholder' => '']) }}
                            </div>
                    ...
                    <div class="col">
                        <fieldset class="border p-2">
                            ...
                            <div class="col-md-12 p-2">
                                ...
                                {{ Form::select('sist_drenag', [
                                    'Existente' => 'Existente',
                                    'Precario' => 'Precário',
                                    'Inexistente' => 'Inexistente'
                                    ],
                                    $vistoria->sist_drenag, ['class' => 'form form-control', 'id' => 'sist_drenag', 'placeholder' => '']) }}
                            </div>
